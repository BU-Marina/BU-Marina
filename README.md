...
## 👩‍💻 Обо мне: | About me:
- **Опыт разработки:** Backend-разработка на FastAPI, Django, Django Rest Framework
- **Знания базы данных:** PostgreSQL, SQLite
- **ORM:** SqlAlchemy, Django ORM
- **Контейнеризация и CI/CD:** Docker, Docker Compose
- **Облачные сервисы:** Yandex Cloud
- **Тестирование:** PyTest, Unittests
- **Фронтенд:** VUE, HTML, CSS
- **Серверы приложений:** Nginx, Gunicorn, Uvicorn, WebSockets
- **Другое:**: Celery, Celery beat, Django channels, Redis, Aiogram
